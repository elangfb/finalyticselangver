...
1. **Complete allSalesData migration** - Replace remaining ~20% of usages
2. **Complete chartDataForAI migration** - Replace all usages
3. **Migrate initialization flags** - Replace all boolean flags
4. **Migrate UI component references** - Replace all SlimSelect instances
